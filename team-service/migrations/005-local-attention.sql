ALTER TABLE ob_shares ADD COLUMN IF NOT EXISTS attention jsonb;

CREATE TABLE IF NOT EXISTS ob_local_attention_decisions (
...
CREATE INDEX IF NOT EXISTS ob_local_attention_decisions_user
  ON ob_local_attention_decisions(workspace_id,user_id,choice);

INSERT INTO ob_schema_version(version) VALUES (5) ON CONFLICT DO NOTHING;
