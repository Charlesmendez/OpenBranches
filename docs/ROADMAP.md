...
| Codex-powered AI execution and scheduling                              | Not enabled; execution boundary unresolved     | Loopback checks on 0.144.4 and 0.153.4, including restricted catalog; `docs/ADVISOR.md` records residual capabilities                    |
