...
| Grouped map, pagination, inventory, inspector, search, activity, demo  | Implemented; refinement ongoing                | Browser and earlier packaged-app checks; session navigation memory and 1,000-branch keyboard/scroll verification in `docs/NAVIGATION.md`           |
...
| Codex task discovery and verified associations                         | Implemented; task opening and summaries remain | Protocol, evidence, cancellation and 1,000-branch fixtures; live local index and desktop connection verified                                       |
...
2. Finish interaction details: broader keyboard/VoiceOver and packaged-app checks, durable view positions across restarts, useful empty/error states, and broader performance verification. Per-project session memory, synchronized inventory scrolling, full-list keyboard navigation, and a 1,000-branch browser fixture are implemented. Evidence-bound review choices, accurate attention counts, paginated findings, and atomic monitoring removal are implemented; broader automated UI coverage remains.
3. Finish the Codex connection: accessible summaries, a verified open-task action, useful handling of missing task titles/metadata, and wider supported-version testing. Account/usage reading, read-only index discovery, version gating, multiple task associations, provenance, pagination bounds, and disconnect behavior are implemented.
