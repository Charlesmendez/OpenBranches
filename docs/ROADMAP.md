...
| Codex-powered AI execution and scheduling                              | Not enabled; execution boundary unresolved     | Local stub detects injected tools and extra context; `docs/ADVISOR.md` records the gate                      |
