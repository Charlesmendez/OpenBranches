...
- `electron/agents/liveEvents`, `hookConfig`, and `liveService`: provider-specific Claude Code/Cursor lifecycle parsing, safe user-hook merge/removal, authenticated loopback ingestion, short-lived memory state, and exact worktree association. See [attribution](AGENT_ATTRIBUTION.md).
